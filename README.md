...
- `k8s/` – Apply cluster baseline and workloads (kubectl/Helm manifests). No AWS provisioning here.
...
- Installed locally: Terraform, AWS CLI, kubectl (and optionally Helm)